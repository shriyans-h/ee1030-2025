...
ax.axline(x_in, y_in, color="blue", label="Arbitrary line")
...
ax.annotate(
    ...
    ha="center",
    arrowprops=dict(
        arrowstyle=f"-[, widthB={a}, lengthB=0.5",  # Bracket style with width and length
        lw=1.5,  # Line width of the bracket
        color="red",  # Color of the bracket
    ),
    fontsize=12,
    color="blue",
)
ax.annotate(
    ...
    va='bottom',
    arrowprops=dict(
        arrowstyle=f"-[, widthB={b}, lengthB=0.5",  # Bracket style with width and length
        lw=1.5,  # Line width of the bracket
        color="red",  # Color of the bracket
    ),
    fontsize=12,
