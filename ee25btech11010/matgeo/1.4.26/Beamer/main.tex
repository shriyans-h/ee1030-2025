...
\[
\vec{P} = 2\vec a - 3\vec b = \brak{2a\\-3b}, \quad 
\vec{Q} = \vec a + \vec b = \brak{a\\b}.
\]
\end{frame}

\begin{frame}{Equation}
Using section formula,
the point $\vec{R}$ dividing $\vec{PQ}$ in ratio $3:1$ is:
\[
...
\begin{frame}{Equation}
\begin{align*}
\vec{R} &= \frac{1}{4}\Big(3\brak{a\\b}+\brak{2a\\-3b}\Big) \\
  &= \frac{1}{4}\brak{3a+2a\\3b-3b} \\
  &= \frac{1}{4}\brak{5a\\0} \\
  &= \brak{\dfrac{5a}{4}\\0}.
\end{align*}
\[
