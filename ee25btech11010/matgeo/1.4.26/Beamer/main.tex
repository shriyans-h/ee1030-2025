...
% Define vector and matrix commands
...
\begin{align}
\vec{R} &= \frac{3\vec{Q} + 1\vec{P}}{3+1} \label{eq:4} \\[6pt]
\vec{R} &= \frac{1}{4}\myvec{\vec{Q} & \vec{P}} \myvec{3 \\ 1}\label{eq:5} \\[6pt]
...
\begin{align}
\vec{R} &= \frac{1}{4}\Big(3\myvec{\vec{a} \\ \vec{b}} + \myvec{2\vec{a} \\ -3\vec{b}}\Big) \label{eq:7} \\[6pt]
